...
> Information-oriented. Exact, complete, dry. Look things up here.

This section describes Vox's interfaces precisely. It does not teach and it does not explain — it tells you what the inputs and outputs are.

## Contents

| Page | What you'll find |
|------|------------------|
| [HTTP API](http-api.md) | Endpoints, request/response schemas, error codes |
| [Pipeline API](pipeline-api.md) | `POST /v1/pipeline/run` spec, stage options, event log format |
